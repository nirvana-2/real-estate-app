...
export default function RentPage() {
    ...
    // Map price ranges to numbers for backend
    const getPriceFilters = (range: string) => {
        if (range === "0-25k") return { maxPrice: 25000 };
        if (range === "25k-50k") return { minPrice: 25001, maxPrice: 50000 };
        if (range === "50k-1L") return { minPrice: 50001, maxPrice: 100000 };
        if (range === "1L+") return { minPrice: 100001 };
        return {};
    };
    ...
    const HERO_IMAGE = "https://images.unsplash.com/photo-1560448204-e02f11c3d0e2?auto=format&fit=crop&q=80&w=1600";

    return (
        <div className="pb-20">
            <PublicHero
                title="Find your perfect rental"
                subtitle="Discover a wide range of rental properties, from cozy apartments to modern office spaces. Tailored to your lifestyle and budget."
                image={HERO_IMAGE}
            >
                ...
                <div className="mt-8 grid grid-cols-1 md:grid-cols-3 gap-4">
                    <div className="bg-white/10 backdrop-blur border border-white/20 rounded-2xl p-4">
                        <label className="text-[10px] font-bold text-slate-300 uppercase tracking-widest block mb-1.5 px-1">
                            Property Type
                        </label>
                        <select
                    ...
                    <div className="bg-white/10 backdrop-blur border border-white/20 rounded-2xl p-4">
                        ...
                        >
                            ...
                            <option value="0-25k" className="text-slate-900">0-25k</option>
                            <option value="25k-50k" className="text-slate-900">25k-50k</option>
                            <option value="50k-1L" className="text-slate-900">50k-1L</option>
                            <option value="1L+" className="text-slate-900">Above 1L</option>
                        </select>
                    </div>
                    <div className="flex items-end">
                        <button className="w-full bg-white/10 backdrop-blur border border-white/20 hover:bg-white/20 text-white rounded-2xl py-4 flex items-center justify-center gap-2 font-bold text-sm transition-all shadow-lg">
            ...
            <section className="container-page py-16">
                ...
                {loading ? (
                    ...
                    <div className="text-center py-20">
                        ...
                        <h3 className="text-xl font-extrabold text-slate-900">No rentals found</h3>
