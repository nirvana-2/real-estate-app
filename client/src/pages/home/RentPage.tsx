...
import { defaultAdvancedFilters } from '../../types/AdvancedFilters.types'; // Fix: Import the value properly
        ...
        <div className="pb-20">
            ...
            >
                ...
                <div className="mt-8 grid grid-cols-1 md:grid-cols-3 gap-4">
                    ...
                    <div className="bg-white/10 backdrop-blur border border-white/20 rounded-2xl p-4">
                        <label className="text-[10px] font-bold text-slate-300 uppercase tracking-widest block mb-1.5 px-1">Monthly Rent</label>
                        <select
                            className="w-full bg-transparent text-white focus:outline-none cursor-pointer font-bold text-sm"
                            value={priceRange}
            ...
            <section className="container-page py-16">
                <div className="flex items-center justify-between mb-8">
                    <h2 className="text-2xl font-extrabold text-slate-900">
                        {properties.length} Rentals Available
                    </h2>
